...
public class ReceitaHomeAdapter extends ArrayAdapter<Receita> {
    ...
    public ReceitaHomeAdapter(@NonNull Context context, int resource, @NonNull List<Receita> dados) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView categoria = (TextView) view.findViewById(R.id.tvCategoriaHome);
        TextView nome = (TextView) view.findViewById(R.id.tvNomeHome);
