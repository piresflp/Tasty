...
public class ReceitaUsuarioAdapter extends ArrayAdapter<Receita> {
    ...
    public ReceitaUsuarioAdapter(@NonNull Context context, int resource, @NonNull List<Receita> dados) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView categoria = (TextView) view.findViewById(R.id.tvReceitaUsuarioCategoria);
        TextView nome = (TextView) view.findViewById(R.id.tvReceitaUsuarioNome);

        Receita receita = dados.get(position);
        categoria.setText(receita.getCategoria().getNome());
        nome.setText(receita.getTitulo());
