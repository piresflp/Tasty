...
public class AddIngredienteAdapter extends ArrayAdapter<String> {
    ...
    public AddIngredienteAdapter(@NonNull Context context, int resource, @NonNull List<String> dados) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView ingrediente = (TextView) view.findViewById(R.id.tvIngredienteItem);

        String str = dados.get(position);
        ingrediente.setText(str);
